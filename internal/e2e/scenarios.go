...
func AttachmentMaterialReadScenario(artifactDirectoryPath string) VirtualSessionScenario {
	...
	return VirtualSessionScenario{
		...
		Turns: []VirtualTurn{{
			...
			ActionResponses: []string{
				actionCallTool("image_read", `{"path":"/workspace/circles/member/inbox/virtual/virtual-conversation-1/virtual-message-001/mascot.png"}`),
...
func CalendarEventLifecycleAcceptanceScenario(artifactDirectoryPath string) VirtualSessionScenario {
	return VirtualSessionScenario{
		...
		AllowedTools:          append(toolcontract.KernelToolNames(), "event_add", "event_update", "event_delete"),
